...
from ghcr_test.ghcr_testImpl import ghcr_test
from ghcr_test.ghcr_testServer import MethodContext
from ghcr_test.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class ghcr_testTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('ghcr_test'):
        ...
        cls.serviceImpl = ghcr_test(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_ghcr_test_" + str(suffix)
